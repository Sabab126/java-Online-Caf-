...
public class CustomerInfoManager extends JFrame implements  ActionListener
{
...
//	private Foolgame mg;
	...
	public CustomerInfoManager(String userId)
	{
		super("customer all info for manager");
		this.userId=userId;
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		{
			ManagerInfo f13 = new ManagerInfo(userId);
			f13.setVisible(true);
