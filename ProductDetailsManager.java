...
public class ProductDetailsManager extends JFrame implements  ActionListener
{
	...
	public ProductDetailsManager(String userId)
	{
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		{
			ManagerInfo f21 = new ManagerInfo(userId);
			f21.setVisible(true);
